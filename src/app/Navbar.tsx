  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 w-full max-w-full overflow-x-clip bg-white/90 backdrop-blur-md border-b border-slate-200">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        {/* Mobile menu */}
        <details ref={detailsRef} className="md:hidden group">
          <summary
          ...
          {/* Opaque mobile dropdown */}
          <div className="fixed left-4 right-4 top-[72px] rounded-xl border border-slate-200 bg-white shadow-lg p-4">
            <div className="flex flex-col gap-4 text-base font-semibold text-slate-900">
              ...
              <a href="#lead" onClick={closeMobileMenu} className="shrink-0">
                <Button
                  variant="primary"
