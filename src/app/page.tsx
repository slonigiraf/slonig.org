    ...
    <main className="min-h-screen font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <QuoteCarousel
        quotes={[
          ...
          { text: "As a computer science professor and education researcher focused on peer instruction and technology-enhanced pedagogy, I appreciate Slonig’s commitment to strengthening human-to-human learning rather than replacing it with AI. While AI-based educational tools are promising, peer tutoring remains a proven approach, and Slonig offers a credible path to scaling it without sacrificing its core strengths.", byline: "Steve Geinitz, Associate Professor, Metropolitan State University of Denver" },
        ]}
      />
